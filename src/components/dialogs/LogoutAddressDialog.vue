        ...
        <q-card-section>
          <div class="row justify-between">
            ...
            <div class="col-1 self-center q-mx-none">
              <q-btn flat size="lg" icon="close" class="q-px-sm" @click.prevent="cancel">
              </q-btn>
            </div>
          </div>
        </q-card-section>
...
export default {
  ...
  methods: {
    open(options) {
      ...
      this.myLocation(); //request location permission
      //address-list
    ...
    setPlace(place) {
      if (place != null) {
        ...
        this.updateAddress(place.geometry.location.lat(), place.geometry.location.lng());
    ...
    setAddress() {
      if (this.addressCity != null && this.addressCity != undefined) {
        ...
        this.$store.dispatch("checkout/setAddressDefault", {
          address: {
            name: this.address,
            area: this.area,
        ...
        this.$store.dispatch("checkout/setLatitude", {
          latitude: this.latitude,
        });
        this.$store.dispatch("checkout/setLongitude", {
