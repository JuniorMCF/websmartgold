      ...
      <q-card-section class="q-py-none scroll content-ring">
        ...
        <div class="row justify-center q-my-none text-center">
          <span class="text-secondary text-weight-bold"
            >*Weight and Price may vary subject to the stock available.</span
          >
        </div>
        ...
        <q-card-section class="q-pa-xs q-px-md">
          ...
          <p class="q-my-sm">
            <span
              class="text-subtitle1 text-info"
              :class="
            ...
            <span
              class="text-subtitle1 q-ml-md text-weight-bold"
...
export default {
  ...
  data: function () {
    return {
      ...
      product: { name: "",price:0.0 ,discounted_price:0.0},
      quantity: 1,
      options: {
        color: "primary",
        width: 700,
  ...
  methods: {
    open(item, options) {
      ...
      this.product = { name: "",price:0.0 ,discounted_price:0.0};
      this.dialog = true;
       
      this.getRingById(item.product_id)
      //console.log(product)
      this.quantity = 1;
    ...
    getRingById(id) {
      this.load = true;
      let endpooint = "get-products-by-id.php";
      let token =
    ...
    addToCart() {
      if (
        ...
        this.$store.getters["auth/getUserId"] != null
      ) {
        this.loadCart = true;
